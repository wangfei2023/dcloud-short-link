 ...
 * @description 多流合并, 分组, 聚合
 * @author Administrator
 * @date 2023/7/23 0023 09:42:05
 * @version 1.0
 */
...
public class DwsShortLinkVisitStatsApp {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // code、referer、isNew
        // province、city、ip
        // browserName、os、deviceType   String, String, Integer, String, String, String, String, String, String对应得是ShortLinkVisitStatsDO的类型;
