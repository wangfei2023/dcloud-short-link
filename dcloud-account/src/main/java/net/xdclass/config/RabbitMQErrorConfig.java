...
public class RabbitMQErrorConfig {
     ...
     * 异常交换机
     */
    private String trafficLinkErrorExchange = "traffic.error.exchange";

    /**
     * 异常队列
     */
    private String trafficLinkErrorQueue = "traffic.error.queue";
    ...
    public TopicExchange errorTopicExchange(){
        ...
        return new TopicExchange(trafficLinkErrorExchange,true,false);
    }
    ...
    public Queue errorQueue(){
        return new Queue(trafficLinkErrorQueue,true);
    }
    ...
    public MessageRecoverer messageRecoverer(){
        ...
        return new RepublishMessageRecoverer(rabbitTemplate, trafficLinkErrorExchange, trafficErrorRoutingKey);
    }
